...
export const metadata: Metadata = buildMetadata({
  title: "Блог: всё о покупке авто из Кореи и ввозе в Россию",
  description:
    "Практические статьи о покупке автомобилей в Южной Корее: как выбрать, как проверить, сколько стоит растаможка через Кыргызстан, Корея или Япония и другие вопросы.",
  path: "/blog",
});
...
export default function BlogPage() {
  ...
  return (
    <>
      <PageHero
        eyebrow="Блог"
        title="Разбираемся в покупке авто из Кореи"
        description="Без воды: только то, что действительно помогает принять решение и не потерять деньги."
